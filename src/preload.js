...
contextBridge.exposeInMainWorld('mangaAPI', {
    ...
    browseManga: (enabledSources, limit) => ipcRenderer.invoke('browse-manga', enabledSources, limit),
    ...
    getPages: (chapterUrl, source, options) => ipcRenderer.invoke('get-pages', chapterUrl, source, options),
    getPagesPaginated: (chapterUrl, source, page, limit) => ipcRenderer.invoke('get-pages-paginated', chapterUrl, source, page, limit),
